...
Plain sqlite3 with numbered SQL migrations in compass/migrations/.
Rule: never edit an applied migration — add a new numbered file.

Deliberately a sibling copy of adscout/db.py, not an import: each tool in
the family must stay independently extractable to its own repository.
